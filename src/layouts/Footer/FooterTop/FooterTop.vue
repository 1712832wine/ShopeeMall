<template>
  <ul class="footertop">
    <section v-for="item in list" v-bind:key="item.id">
      <h2 class="shopee-footer-section__heading">{{ item.title }}</h2>
      <p v-html="item.p" class="shopee-footer-section__content"></p>
    </section>
  </ul>
</template>
<script>
